...
(cl:defmethod cl:initialize-instance :after ((m <Prediction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Prediction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_detection-msg:<Prediction> is deprecated: use object_detection-msg:Prediction instead.")))

(cl:ensure-generic-function 'classes-val :lambda-list '(m))
(cl:defmethod classes-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:classes-val is deprecated.  Use object_detection-msg:classes instead.")
  (classes m))

(cl:ensure-generic-function 'probabilities-val :lambda-list '(m))
(cl:defmethod probabilities-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:probabilities-val is deprecated.  Use object_detection-msg:probabilities instead.")
  (probabilities m))

(cl:ensure-generic-function 'xmin-val :lambda-list '(m))
(cl:defmethod xmin-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:xmin-val is deprecated.  Use object_detection-msg:xmin instead.")
  (xmin m))

(cl:ensure-generic-function 'ymin-val :lambda-list '(m))
(cl:defmethod ymin-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:ymin-val is deprecated.  Use object_detection-msg:ymin instead.")
  (ymin m))

(cl:ensure-generic-function 'xmax-val :lambda-list '(m))
(cl:defmethod xmax-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:xmax-val is deprecated.  Use object_detection-msg:xmax instead.")
  (xmax m))

(cl:ensure-generic-function 'ymax-val :lambda-list '(m))
(cl:defmethod ymax-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:ymax-val is deprecated.  Use object_detection-msg:ymax instead.")
  (ymax m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:distance-val is deprecated.  Use object_detection-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Prediction>))
...
(cl:defmethod xcoord-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:xcoord-val is deprecated.  Use object_detection-msg:xcoord instead.")
  (xcoord m))

(cl:ensure-generic-function 'ycoord-val :lambda-list '(m))
(cl:defmethod ycoord-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:ycoord-val is deprecated.  Use object_detection-msg:ycoord instead.")
  (ycoord m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Prediction>)))
  ...
  "d88eff2e3e2eac200735b76da90deaa4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Prediction)))
  "Returns md5sum for a message object of type 'Prediction"
  "d88eff2e3e2eac200735b76da90deaa4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Prediction>)))
  ...
  (cl:format cl:nil "string[] classes~%float64[] probabilities~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%float64 distance~%float64 angle~%float64 xcoord~%float64 ycoord~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Prediction)))
  "Returns full string definition for message of type 'Prediction"
  (cl:format cl:nil "string[] classes~%float64[] probabilities~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%float64 distance~%float64 angle~%float64 xcoord~%float64 ycoord~%~%~%"))
