...
(cl:defmethod cl:initialize-instance :after ((m <Prediction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Prediction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetsontx1_cvmodule-msg:<Prediction> is deprecated: use jetsontx1_cvmodule-msg:Prediction instead.")))

(cl:ensure-generic-function 'classes-val :lambda-list '(m))
(cl:defmethod classes-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:classes-val is deprecated.  Use jetsontx1_cvmodule-msg:classes instead.")
  (classes m))

(cl:ensure-generic-function 'probabilities-val :lambda-list '(m))
(cl:defmethod probabilities-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:probabilities-val is deprecated.  Use jetsontx1_cvmodule-msg:probabilities instead.")
  (probabilities m))

(cl:ensure-generic-function 'xmin-val :lambda-list '(m))
(cl:defmethod xmin-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:xmin-val is deprecated.  Use jetsontx1_cvmodule-msg:xmin instead.")
  (xmin m))

(cl:ensure-generic-function 'ymin-val :lambda-list '(m))
(cl:defmethod ymin-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:ymin-val is deprecated.  Use jetsontx1_cvmodule-msg:ymin instead.")
  (ymin m))

(cl:ensure-generic-function 'xmax-val :lambda-list '(m))
(cl:defmethod xmax-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:xmax-val is deprecated.  Use jetsontx1_cvmodule-msg:xmax instead.")
  (xmax m))

(cl:ensure-generic-function 'ymax-val :lambda-list '(m))
(cl:defmethod ymax-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:ymax-val is deprecated.  Use jetsontx1_cvmodule-msg:ymax instead.")
  (ymax m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:id-val is deprecated.  Use jetsontx1_cvmodule-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'face-val :lambda-list '(m))
(cl:defmethod face-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:face-val is deprecated.  Use jetsontx1_cvmodule-msg:face instead.")
  (face m))

(cl:ensure-generic-function 'smile-val :lambda-list '(m))
(cl:defmethod smile-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:smile-val is deprecated.  Use jetsontx1_cvmodule-msg:smile instead.")
  (smile m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:distance-val is deprecated.  Use jetsontx1_cvmodule-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:angle-val is deprecated.  Use jetsontx1_cvmodule-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'xcoord-val :lambda-list '(m))
(cl:defmethod xcoord-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:xcoord-val is deprecated.  Use jetsontx1_cvmodule-msg:xcoord instead.")
  (xcoord m))

(cl:ensure-generic-function 'ycoord-val :lambda-list '(m))
(cl:defmethod ycoord-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetsontx1_cvmodule-msg:ycoord-val is deprecated.  Use jetsontx1_cvmodule-msg:ycoord instead.")
  (ycoord m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Prediction>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'smile))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'smile))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Prediction>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'probabilities)))
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'smile) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'smile) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Prediction>)))
  ...
  (cl:format cl:nil "string[] classes~%float64[] probabilities~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%int64 id~%string face~%string smile~%float64 distance~%float64 angle~%float64 xcoord~%float64 ycoord~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Prediction)))
  "Returns full string definition for message of type 'Prediction"
  (cl:format cl:nil "string[] classes~%float64[] probabilities~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%int64 id~%string face~%string smile~%float64 distance~%float64 angle~%float64 xcoord~%float64 ycoord~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Prediction>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'smile))
     8
     8
     8
     8
