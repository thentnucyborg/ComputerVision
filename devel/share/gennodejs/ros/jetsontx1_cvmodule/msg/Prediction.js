...
class Prediction {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.string(obj.face, buffer, bufferOffset);
    // Serialize message field [smile]
    bufferOffset = _serializer.string(obj.smile, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.face = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [smile]
    data.smile = _deserializer.string(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += object.face.length;
    length += object.smile.length;
    return length + 88;
  }
